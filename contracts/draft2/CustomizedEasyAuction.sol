...
// modified from https://github.com/Gnosis-Auction/auction-contracts/blob/main/contracts/EasyAuction.sol
// we want to remove order canceling
// the auctioned amount should only be set later
...
contract CustomizedEasyAuction is Ownable {
